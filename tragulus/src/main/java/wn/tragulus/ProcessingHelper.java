...
//    }
    ...
    public boolean noErrorReports(Set<String> ignoreCodes) {
        return getDiagnosticQ().stream().noneMatch(diag ->
                diag.getKind() == Diagnostic.Kind.ERROR && !ignoreCodes.contains(diag.getCode()));
    }
